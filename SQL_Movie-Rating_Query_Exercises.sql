...
SELECT Re.name as "Reviewer Name", M.title as "Movie Title", R.stars as "Stars", R.ratingDate as "Rating Date" 
FROM Reviewer Re JOIN Rating R USING(rID) JOIN Movie M USING(mID)
